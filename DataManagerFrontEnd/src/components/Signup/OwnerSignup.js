                ...
                <div class="login-form">
                    <div class="main-div-signups">
                        ...
                        <div class="form-group">
                                <input onChange = {this.usernameChangeHandler} type="email" class="form-control" name="username" placeholder="Email"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                <input onChange = {this.typeChangeHandler} type="text" class="form-control" name="type" value="Owner" placeholder="Owner"/>
                        </div>
                        <div class="form-group">
                                <input onChange = {this.firstnameChangeHandler} type="text" class="form-control" name="firstname" placeholder="First Name"/>
                        </div>

                        <button onClick = {this.submitSignup} class="btn btn-primary">Submit</button>                 
                    </div>
